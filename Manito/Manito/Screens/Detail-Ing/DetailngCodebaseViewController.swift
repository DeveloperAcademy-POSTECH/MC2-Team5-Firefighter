...
final class DetailingCodebaseViewController: BaseViewController {
    ...
    private let detailIngService: DetailRoomAPI = DetailRoomAPI(apiService: APIService())
    private let detailDoneService: DetailRoomAPI = DetailRoomAPI(apiService: APIService())
